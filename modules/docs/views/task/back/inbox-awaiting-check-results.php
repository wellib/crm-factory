...
$this->title = Module::t('task', 'INBOX');
$this->params['breadcrumbs'][] = $this->title;
$this->params['breadcrumbs'][] = Module::t('task', 'AWAITING_CHECK_RESULTS');
?>
<?php Panel::begin(); ?>

    <h1><?= Html::encode(Module::t('task', 'INBOX') . ' / '. Module::t('task', 'AWAITING_CHECK_RESULTS')) ?></h1>
