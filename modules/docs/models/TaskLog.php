...
/**
 * This is the model class for collection "docs_task_log".
 *
...
class TaskLog extends \yii\mongodb\ActiveRecord
{
    ...
    {
        return Url::to(['/docs/task/download-attached-file', 'id' => (string) $this->_id, 'filename' => $filename, 'type' => 'log'], $scheme);
    }
