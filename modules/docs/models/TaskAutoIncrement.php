...
/**
 * Класс реализующий счетчик инкрементация числового уникального id для модели Task
 ...
 */
class TaskAutoIncrement extends Settings
{
    const KEY = 'task-auto-increment';
     ...
     *
     * @return TaskAutoIncrement|array|null
     */
