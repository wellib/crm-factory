...
/**
 * This is the model class for collection "docs_Doc".
 *
...
class Doc extends \yii\mongodb\ActiveRecord
{
    ...
    const SCENARIO_INBOX  = 'inbox';
    const SCENARIO_OUTBOX = 'outbox';
    const SCENARIO_NOTE   = 'note';


    public static function inboxStatus()
    {
        return [
            1 => 'Не выполнено',
            2 => 'В обработке',
    ...
    public static function outboxStatus()
    {
        return [
            1 => 'Пришел',
            2 => 'Не пришел',
    ...
    public function rules()
    {
        return [
            ...
            [['perform_date', 'deadline_date', 'start_date', 'end_date'], 'match',
                ...
                'message' => Module::t('Doc', 'DATE_FIELD__VALIDATE_MESSAGE__BAD_DATE', [
            ...
            //[['deadlineTimestampFormat', 'lastDeadlineFormat'], 'match', 'pattern' => '/^[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{4}$/i' , 'message' => Module::t('Doc', 'ATTR__DEADLINE_FORMAT__VALIDATE_MESSAGE__BAD_DATE', [
            //    'format' => 'дд.мм.гггг'
            //])],
            //[['deadlineTimeFormat'], function ($attribute, $params) {
            //    if (in_array($this->deadline_type, [Doc::DEADLINE_TYPE_ONE_TIME])) {
            ...
            //    if (in_array($this->deadline_type, [Doc::DEADLINE_TYPE_EVERY_DAY, Doc::DEADLINE_TYPE_EVERY_WEEK, Doc::DEADLINE_TYPE_EVERY_MONTH])) {
    ...
    {
        return [
            '_id'    => Module::t('Doc', 'ATTR__ID__LABEL'),

            'id'     => Module::t('Doc', 'ATTR__ID__LABEL'),
            'status' => Module::t('Doc', 'ATTR__STATUS__LABEL'),

            'subject'     => Module::t('Doc', 'ATTR__SUBJECT__LABEL'),
            'description' => Module::t('Doc', 'ATTR__DESCRIPTION__LABEL'),
            'priority'    => Module::t('Doc', 'ATTR__PRIORITY__LABEL'),

            'deadline_type'        => Module::t('Doc', 'ATTR__DEADLINE_TYPE__LABEL'),
            'deadline_every_week'  => Module::t('Doc', 'ATTR__DEADLINE_EVERY_WEEK__LABEL'),
            'deadline_every_month' => Module::t('Doc', 'ATTR__DEADLINE_EVERY_MONTH__LABEL'),
            'deadline_every_date'  => Module::t('Doc', 'ATTR__DEADLINE_EVERY_DATE__LABEL'),

            'perform_date'      => Module::t('Doc', 'ATTR__PERFORM_DATE__LABEL'),
            'perform_time'      => Module::t('Doc', 'ATTR__PERFORM_TIME__LABEL'),
            'perform_timestamp' => Module::t('Doc', 'ATTR__PERFORM_TIMESTAMP__LABEL'),

            'deadline_date'      => Module::t('Doc', 'ATTR__DEADLINE_DATE__LABEL'),
            'deadline_time'      => Module::t('Doc', 'ATTR__DEADLINE_TIME__LABEL'),
            'deadline_timestamp' => Module::t('Doc', 'ATTR__DEADLINE_TIMESTAMP__LABEL'),

            'start_date'      => Module::t('Doc', 'ATTR__START_DATE__LABEL'),
            'start_time'      => Module::t('Doc', 'ATTR__START_TIME__LABEL'),
            'start_timestamp' => Module::t('Doc', 'ATTR__START_TIMESTAMP__LABEL'),

            'end_date'      => Module::t('Doc', 'ATTR__END_DATE__LABEL'),
            'end_time'      => Module::t('Doc', 'ATTR__END_TIME__LABEL'),
            'end_timestamp' => Module::t('Doc', 'ATTR__END_TIMESTAMP__LABEL'),

            'approve_execute_deadline_timestamp' => Module::t('Doc', 'ATTR__APPROVE_EXECUTE_DEADLINE_TIMESTAMP__LABEL'),
            'check_results_deadline_timestamp'   => Module::t('Doc', 'ATTR__CHECK_RESULTS_DEADLINE_TIMESTAMP__LABEL'),

            '_attached_files'     => Module::t('Doc', 'ATTR__ATTACHED_FILES__LABEL'),
            'attachedFilesUpload' => Module::t('Doc', 'ATTR__ATTACHED_FILES_UPLOAD__LABEL'),

            '_users_approve_execute'           => Module::t('Doc', 'ATTR__USERS_APPROVE_EXECUTE__LABEL'),
            '_users_approve_execute_response'  => Module::t('Doc', 'ATTR__USERS_APPROVE_EXECUTE_RESPONSE__LABEL'),

            '_users_performers'                => Module::t('Doc', 'ATTR__USERS_PERFORMERS__LABEL'),
            '_users_performers_finished'       => Module::t('Doc', 'ATTR__USERS_PERFORMERS_FINISHED__LABEL'),

            '_users_check_result'              => Module::t('Doc', 'ATTR__USERS_CHECK_RESULT__LABEL'),
            '_users_check_result_response'     => Module::t('Doc', 'ATTR__USERS_CHECK_RESULT_RESPONSE__LABEL'),

            '_users_notify_after_finished'     => Module::t('Doc', 'ATTR__USERS_NOTIFY_AFTER_FINISHED__LABEL'),
            
            '_author'     => Module::t('Doc', 'ATTR__AUTHOR__LABEL'),

            'created_at' => Module::t('Doc', 'ATTR__CREATED_AT__LABEL'),
            'updated_at' => Module::t('Doc', 'ATTR__UPDATED_AT__LABEL'),
            ...
            '_based_on' => 'Основание',
            'inbox_status' => 'Статус',
            'response_timstamp' => 'Дата',
            'response_date' => 'Дата',
            '_inbox_users' => 'Ожидать отписки от',
            '_inbox_users_response' => 'Дата',
            '_outbox_users' => 'Исполнители',
            'outbox_status' => 'Ответ на данный документ',
    ...
    {
        return [
            self::PRIORITY__LOW    => Module::t('Doc', 'PRIORITY__LOW'),
            self::PRIORITY__MEDIUM => Module::t('Doc', 'PRIORITY__MEDIUM'),
            self::PRIORITY__HIGH   => Module::t('Doc', 'PRIORITY__HIGH'),
        ];
    }
    ...
    public function getPriorityLabel()
    {
        ...
        return Module::t('Doc', 'PRIORITY__UNKNOWN');
    }
    ...
    {
        return [
            self::DEADLINE_TYPE__ONE_TIME    => Module::t('Doc', 'DEADLINE_TYPE__ONE_TIME'),
            self::DEADLINE_TYPE__EVERY_DAY   => Module::t('Doc', 'DEADLINE_TYPE__EVERY_DAY'),
            self::DEADLINE_TYPE__EVERY_WEEK  => Module::t('Doc', 'DEADLINE_TYPE__EVERY_WEEK'),
            self::DEADLINE_TYPE__EVERY_MONTH => Module::t('Doc', 'DEADLINE_TYPE__EVERY_MONTH'),
            self::DEADLINE_TYPE__EVERY_DATE  => Module::t('Doc', 'DEADLINE_TYPE__EVERY_DATE'),
        ];
    }
    ...
    public static function statusList($short = false)
    {
        ...
        return [
            self::STATUS__APPROVAL_AWAITING      => Module::t('Doc', 'STATUS__APPROVAL_AWAITING' . $short),
            self::STATUS__APPROVAL_FAILED        => Module::t('Doc', 'STATUS__APPROVAL_FAILED' . $short),
            self::STATUS__IN_PROGRESS            => Module::t('Doc', 'STATUS__IN_PROGRESS' . $short),
            self::STATUS__CHECK_RESULTS_AWAITING => Module::t('Doc', 'STATUS__CHECK_RESULTS_AWAITING' . $short),
            self::STATUS__CHECK_RESULTS_FAILED   => Module::t('Doc', 'STATUS__CHECK_RESULTS_FAILED' . $short),
            self::STATUS__DONE                   => Module::t('Doc', 'STATUS__DONE' . $short),
        ];
    }
    ...
    public function getStatusLabel($short = false)
    {
        ...
        return Module::t('Doc', 'STATUS__UNKNOWN');
    }
    ...
    public function beforeSave($insert)
    {
        ...
        if ($this->isNewRecord) {
            ...
            $this->id = DocAutoIncrement::getNextAutoIncrementID();
        }
        return parent::beforeSave($insert); // docs: Change the autogenerated stub
    }
    ...
    public function afterValidate()
    {
        ...
        parent::afterValidate(); // docs: Change the autogenerated stub
    }
    ...
    //{
    //    parent::afterFind(); // docs: Change the autogenerated stub
    ...
    //        //    //DocLog::createNotify($this, DocLog::NOTIFY_AGAIN_APPROVE);
    //        //    $this->status = self::STATUS_AWAITING_APPROVAL;
    //        //}
    ...
    //                    if ($this->deadline_repeats_counter == $this->deadline_repeats_number) {
    //                        //DocLog::createNotify($this, DocLog::NOTIFY_SET_STATUS_DONE);
    ...
    //        if (count($this->_users_approve_execute) > 0) {
    //            if ($this->isNewRecord) {
    //                DocLog::createNotify($this, DocLog::NOTIFY_Doc_AWAITING_APPROVAL);
    //            } else {
    //                DocLog::createNotify($this, DocLog::NOTIFY_AGAIN_APPROVE);
    //            }
    //
    ...
    //        } else {
    //            DocLog::createNotify($this, DocLog::NOTIFY_SET_STATUS_IN_PROGRESS);
    ...
    {
        return ['/docs/doc/user-action', 'id' => (string) $this->_id, 'type' => $actionType];
    }
        ...
        $actions = [
            ...
            'approve_execute' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    DocLog::createNotify($this, DocLog::NOTIFY_USER_APPROVED_Doc, self::getUserModelId($me));

                    // флешка для того что бы в actionView показать что типа задача выполнена
                    Yii::$app->getSession()->setFlash(DocLog::NOTIFY_SET_STATUS_DONE, true);
                    ...
                    if (count($that->_users_approve_execute) === count($that->_users_approve_execute_response)) {
                        ...
                        if ($approved === false) {
                            ...
                            DocLog::createNotify($this, DocLog::NOTIFY_Doc_DENIED_APPROVAL);
            ...
            'reject_execute' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    $that->setAttribute('_users_approve_execute_response', $response);
                    //DocLog::createNotify($this, DocLog::NOTIFY_USER_DISAPPROVED_Doc, self::getUserModelId($me));

                    // флешка для того что бы в actionView показать что типа задача выполнена
                    Yii::$app->getSession()->setFlash(DocLog::NOTIFY_SET_STATUS_DONE, true);

                    $model = new DocLog();
                    //$model->setScenario(DocLog::SCE);
                    if ($model->load(Yii::$app->request->post()) ) {
                        $model->Doc_id = $that->_id;
                        $model->_user = Yii::$app->getUser()->getIdentity()->_id;
                        $model->type = DocLog::NOTIFY_USER_DISAPPROVED_Doc;
                ...
                'renderBtn' => function($action) {
                    $id = '#' . DocLog::NOTIFY_USER_DISAPPROVED_Doc . '-modal';
                ...
                'renderHtml' => function($action) use ($that) {
                    return Yii::$app->controller->renderPartial('log/' . DocLog::NOTIFY_USER_DISAPPROVED_Doc . '-modal', [
                        'model' => new DocLog(['scenario' => DocLog::SCENARIO_DEFAULT]),
                        'Doc_id' => $that->getId(),
                        'action' => $action['url'],
                    ]);
                },
            ...
            //        DocLog::createNotify($this, DocLog::NOTIFY_USER_STARTED_PERFORM, self::getUserModelId($me));
            ...
            'finished_perform' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    //    //DocLog::createNotify($this, DocLog::NOTIFY_USER_FINISHED_PERFORM, self::getUserModelId($me));
                        ...
                        if ($model->load(Yii::$app->request->post()) ) {
                            $model->Doc_id = $that->_id;
                            $model->_user = Yii::$app->getUser()->getIdentity()->_id;
                            $model->type = DocLog::NOTIFY_USER_FINISHED_PERFORM;
                            $model->attachedFilesUpload = UploadedFile::getInstances($model, 'attachedFilesUpload');
                            $model->uploadAttachedFiles();
                            //if (!empty($model->comment)) {
                            $model->save(false);
                    ...
                    //
                    //} else {
                    //    DocLog::createNotify($this, DocLog::NOTIFY_USER_FINISHED_PERFORM_CONTROL, self::getUserModelId($me));
                    //}
                    ...
                    if (count($that->_users_performers) === count($that->_users_performers_finished)) {
                        ...
                        if ($approved === true) {
                            ...
                            if (count($that->_users_check_result) > 0) {
                                ...
                                DocLog::createNotify($this, DocLog::NOTIFY_SET_STATUS_AWAITING_CHECK_RESULTS);
                                $that->status = self::STATUS__CHECK_RESULTS_AWAITING;
                                $that->setControlResultsDeadline();
                            } else {
                                // или задача выполнена
                                DocLog::createNotify($this, DocLog::NOTIFY_SET_STATUS_DONE);
                                Yii::$app->getSession()->setFlash(DocLog::NOTIFY_SET_STATUS_DONE, true); // флешка для того что бы сделать редирект в контроллере
                ...
                //},
                'renderBtn' => function($action) {
                    $id = '#' . DocLog::NOTIFY_USER_FINISHED_PERFORM . '-modal';
                    return  Html::a($action['label'], $id, [
                        'class' => 'btn btn-primary',
                        'data-toggle' => 'modal',
                        'data-target' => $id
                ...
                'renderHtml' => function($action) use ($that) {
                    return Yii::$app->controller->renderPartial('log/' . DocLog::NOTIFY_USER_FINISHED_PERFORM . '-modal', [
                        'model' => new DocLog(['scenario' => DocLog::SCENARIO_DEFAULT]),
                        'Doc_id' => $that->getId(),
                        'action' => $action['url'],
                    ]);
            ...
            'back_perform' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    //if ($awaitingAnswersUsersAttr == '_users_performers') {
                        DocLog::createNotify($this, DocLog::NOTIFY_USER_BACK_PERFORM, self::getUserModelId($me));
                    //} else {
                    //    DocLog::createNotify($this, DocLog::NOTIFY_USER_BACK_PERFORM_CONTROL, self::getUserModelId($me));
                    //}
            ...
            'approve_results' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    DocLog::createNotify($this, DocLog::NOTIFY_USER_APPROVED_RESULTS, self::getUserModelId($me));
                    ...
                    if (count($that->_users_check_result) === count($that->_users_check_result_response)) {
                        ...
                        if ($approved === true) {
                            ...
                            DocLog::createNotify($this, DocLog::NOTIFY_SET_STATUS_DISAPPROVE_RESULTS);
            ...
            'reject_results' => [
                ...
                'action' => function() use ($that, $me) {
                    ...
                    $that->setAttribute('_users_check_result_response', $response);
                    //DocLog::createNotify($this, DocLog::NOTIFY_USER_DISAPPROVED_RESULTS, self::getUserModelId($me));
                    ...
                    if ($model->load(Yii::$app->request->post()) ) {
                        $model->Doc_id = $that->_id;
                        $model->_user = Yii::$app->getUser()->getIdentity()->_id;
                        $model->type = DocLog::NOTIFY_USER_DISAPPROVED_RESULTS;
                        $model->attachedFilesUpload = UploadedFile::getInstances($model, 'attachedFilesUpload');
                        $model->uploadAttachedFiles();
                        //if (!empty($model->comment)) {
                            $model->save(false);
                ...
                'renderBtn' => function($action) {
                    $id = '#' . DocLog::NOTIFY_USER_DISAPPROVED_RESULTS . '-modal';
                    return  Html::a($action['label'], $id, [
                ...
                'renderHtml' => function($action) use ($that) {
                    return Yii::$app->controller->renderPartial('log/' . DocLog::NOTIFY_USER_DISAPPROVED_RESULTS . '-modal', [
                        'model' => new DocLog(['scenario' => DocLog::SCENARIO_DEFAULT]),
                        'Doc_id' => $that->getId(),
                        'action' => $action['url'],
                    ]);
    ...
    {
        return Url::to(['/docs/doc/download-attached-file', 'id' => (string) $this->_id, 'filename' => $filename], $scheme);
    }
    ...
    {
        return ['/docs/doc/view', 'id' => $this->getId()];
    }
