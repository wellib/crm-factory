...
namespace app\modules\docs\validators;
...
class DateCompareValidator extends Validator
{
    ...
    {
        $value = strtotime($model->$attribute);
        if ($value === false) {
        ...
        if ($this->compareValue !== null) {
            $compareLabel = $compareValueOrAttribute = $this->compareValue;
            var_dump($compareLabel);
            if (is_string($this->compareValue)) {
                $this->compareValue = strtotime($this->compareValue);
            }
            $compareValue = $this->compareValue;
        } else {
            $compareAttribute = $this->compareAttribute === null ? $attribute . '_repeat' : $this->compareAttribute;
            $compareValue = strtotime($model->$compareAttribute);
